...
//fake reply gc
 const reply = (teks) => {
zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `KLIK DI SINI UNTUK MELIHAT SEPUTAR OWNER KU🥰`,"body": `${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/zaki.jpg`),"sourceUrl": `${link}`}}}, { quoted: m})
}
//FAKE QUOTED
const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@g.us"},"message": {"groupInviteMessage": {"groupJid": "6287772549185-1622678501@g.us","inviteCode": "https://chat.whatsapp.com/HYcaTsosKuCJcR1zfvaXd9","groupName": "Group Jb Owner Ku🥰", "caption": `${footer}`, 'jpegThumbnail': ('./media/zaki.jpg')}}}
...
`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: txt.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `${footer1}`, hydratedButtons: [{ urlButton: { displayText: 'Group Jb Owner Ku🥰', url: 'https://chat.whatsapp.com/HYcaTsosKuCJcR1zfvaXd9'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }, { quickReplyButton: { displayText: 'List Menu', id: 'allmenu', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
break
case 'command': case 'allmenu': case 'listmenu': {
var butonnya =
[{ urlButton: { displayText: 'Group Jb OwnerKu', url: 'https://chat.whatsapp.com/HYcaTsosKuCJcR1zfvaXd9'} }, 
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: `${ccomannya}`, locationMessage: { jpegThumbnail: fs.readFileSync('./media/allmenu.jpg') }, hydratedFooterText: `${footer}`, hydratedButtons: [{ urlButton: { displayText: 'Group Jb Owner Ku🥰', url: 'https://chat.whatsapp.com/HYcaTsosKuCJcR1zfvaXd9'} }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
...
break
case 'script': case 'sc':
                reply('𝗠𝗔𝗨 𝗦𝗖 𝗡𝗬𝗔?𝗕𝗘𝗟𝗜 🗿 𝗖𝗛𝗔𝗧 𝗢𝗪𝗡𝗘𝗥 𝗝𝗜𝗞𝗔 𝗠𝗜𝗡𝗔𝗧 𝗛𝗔𝗥𝗚𝗔 𝗠𝗨𝗟𝗔𝗜 𝗗𝗔𝗥𝗜 𝟮𝟬𝗞 𝗦𝗔𝗠𝗣𝗔𝗜 𝟲𝟬𝗞 𝗙𝗨𝗟𝗟 𝗧𝗨𝗧𝗢𝗥 𝗣𝗘𝗠𝗔𝗦𝗔𝗡𝗚𝗔𝗡 !')
break
